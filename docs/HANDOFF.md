...
آخر تحديث: 2026-09-16 · `main` يحوي T0.1–T0.20 وT1.1–T1.12 (PRs #1–#33 كلها مدمجة) · التالي: T1.13
...
> اقرأ `docs/HANDOFF.md` ثم نفّذ ما فيه. لا تعد تصميم شيء؛ كل شاشة من إطارها المرسوم. ابدأ T1.13 بعد اجتياز فحوص §5.
...
#22–#33 phase1/t1.1 … t1.12              → main (كل واحد دُمج بعد خضرة CI)
```
