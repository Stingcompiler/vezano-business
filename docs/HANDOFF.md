...
المجاميع بعد T1.43: **pytest 373 · Vitest 348 (+1 todo) · Playwright 921 (307 × 3 مقاسات) · gate 7/7** (Playwright الكامل لم يُشغَّل محلياً في هذه الجلسة — CI هو المرجع؛ البوابة 7/7 محلياً على Django حقيقي).
