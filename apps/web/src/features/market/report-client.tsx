    ...
    <>
      ...
      {r.reason === "impersonation" ? (
        <>
          ...
          <p className="acc-choice__note">
            بلّغتَ أن ملفاً في السوق يستخدم اسم منشأتك وشعارها. المراجعة عند مشرف السوق وأقصى إجراء
            هو تعليق النشر. للمنشأة المعلَّقة حق اعتراض موثق، والقرار ونتيجته يظهران لك بلا تفاصيل
            داخلية عنها.
          </p>
        </>
      ) : null}
          ...
          <div className="acc-card__body">
            ...
            {!reportId && !sent && (offer || supplier) ? (
              <>
                ...
                <p className="acc-choice__note">
                  <strong>البلاغ لا يُعلّق شيئاً بنفسه</strong> · التعليق قرار مراجِع بشري عند مشرف
                  السوق. لو كان البلاغ يُخفي عرضاً تلقائياً لصار سلاحاً بيد منافس — عشرة بلاغات
