            ...
            {state === "success" && published ? (
              ...
              >
                ...
                <p className="acc-choice__note">
                  <strong>الصلاحية تبدأ الآن</strong> · وتنتهي بتاريخها ما لم تُجدَّد صريحاً
                  (MP-13). النشر ليس التزاماً أبدياً — وانتهاؤه ليس عطلاً.
                </p>
              </Notice>
            ) : null}
            ...
            {state !== "success" ? (
              <>
                ...
                <p className="acc-choice__note">
                  ...
                  النشر قرارٌ صنفاً صنفاً بسعرٍ مقصود (ACC-120). والرصيد الداخلي لا يُنشر أبداً.
                </p>
                <SelectField
                ...
                <RadioGroupField
                  ...
                  options={[
                    ...
                    },
                    {
                      ...
                      hint: "ACC-121: منشأة ثالثة لا ترى هذا السعر ولا تعرف بوجوده. الرفض عام بلا تسريب.",
                    },
                    {
                      value: "followers",
                      label: "متابعو منشأتك فقط",
                      hint: "المتابعة اشتراك B2B مستقل، وإلغاؤه لا يمحو أحداث الطلبات السابقة — ACC-134.",
                    },
                  ]}
                />
                    ...
                    disabledReason={
                      preview && !preview.can_publish
                        ...
                        : preview && !preview.seller_verified
                          ? "النشر بعد اعتماد دور البائع (MP-08)"
                          : undefined
                    }
                  >
