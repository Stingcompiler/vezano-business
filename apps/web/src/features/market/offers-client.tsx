          ...
          <div className="acc-card__body">
            ...
            {state === "loading" ? (
              <Notice kind="info" title="جلب عروضك">
                ...
                <p className="acc-choice__note">
                  ...
                  العدّاد يجعل الفقد المؤجَّل مرئياً قبل وقوعه (MP-13).
                </p>
              </Notice>
            ) : null}
            ...
            {state === "empty" ? (
              <Notice kind="empty" title="لا عروض بعد">
                <p className="acc-lead">
                  النشر اختيار صنف صنف مع جمهوره وسعره وصلاحيته (MP-11). من ينشر ٦٤٠ صنفاً بضغطة
                  يكشف كلفته وتوفّره لمنافسيه بلا أن يقصد.
                </p>
                {!data?.seller_verified ? (
                  <p className="acc-choice__note">النشر بعد اعتماد دور البائع (MP-08).</p>
                ) : null}
              </Notice>
            ) : null}
            ...
            {data && data.total ? (
              <p className="acc-choice__note">
                ...
                وصلاحيته (MP-11). من ينشر ٦٤٠ صنفاً بضغطة يكشف كلفته وتوفّره لمنافسيه بلا أن يقصد.
              </p>
            ) : null}
          </div>
        </div>
