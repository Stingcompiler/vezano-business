            ...
            {state === "permission_denied" ? (
              ...
              >
                ...
                <p className="acc-choice__note">
                  ...
                  <strong>رفض عام</strong> · كأنها غير موجودة (ACC-121). وتبديل الحساب على نفس
                  الجهاز لا يُظهر كاش الحساب السابق (ACC-138) — العزل بالحساب لا بالجهاز.
                </p>
              </Notice>
            ) : null}
                ...
                {current ? (
                  <>
                    ...
                    <p className="acc-choice__note">
                      ...
                      صفحة «الرابط لم يعد صالحاً» نفسها التي يراها من فتح رابطاً غير موجود — PUB-04.
                      لا رسالة «لا تملك صلاحية لهذه القائمة»، لأنها تخبره أن القائمة موجودة ومن
                      يملكها.
                    </p>
                  </>
                ) : null}
