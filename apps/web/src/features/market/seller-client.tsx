        ...
        <div className="cat-table pos-card">
          ...
          <div className="acc-card__body">
            ...
            {state === "loading" && acc ? (
              ...
              >
                <p className="acc-lead">الطلب مرفوع وأدلته عند مشرف السوق (PLT-06).</p>
                <p className="acc-choice__note">
            ...
            {state === "success" ? (
              ...
              >
                ...
                <p className="acc-choice__note">
                  ...
                  (ACC-118 · ACC-120). الباب فُتح والدخول قرارات لاحقة كلٌّ بشاشته.
                </p>
              </Notice>
            ) : null}
            ...
            <p className="acc-lead">
              <strong>حدود الشارة</strong> · {acc?.badge_limits ?? ""} هذا النص يظهر حرفياً في MP-03
              بجوار الشارة.
            </p>
            <div className="mp-paths">
              <p className="acc-choice__note">
                <strong>قرار معتمد — G-06 المسار ب</strong> · تحقق الهوية الذي يكفي للشراء لا يكفي
                للبيع: من ينشر سعراً يبني عليه غيره قراراً مالياً. فحساب واحد، ودور بائع يُفتح بطلب
                تحقق منفصل يراجعه مشرف السوق في PLT-06 قبل أول عرض — بانتظار بشري صريح لا إخفاء له.
                المسارات المرفوضة موثقة أدناه.
              </p>
              <p className="acc-choice__note">
              ...
              <p className="acc-choice__note">
                مورّد سجّلته في دفترك المحلي (PTY-02) لا يحصل على ملف عام في السوق ولا يُدعى إليه —
                ACC-118. سجلّك الخاص ليس إعلاناً عن غيرك.
              </p>
            </div>
          </div>
        </div>
