          ...
          <div className="cat-head">
            ...
            <span className="cat-head__hint">
              {state === "offline"
                ...
                : "السلة مقسومة بالمورد: لكل قسم حدّه الأدنى ورسومه وشروط تنفيذه، ولكل قسم زرّ إرسال مستقل. الإرسال يُنشئ طلباً لكل مورد."}
            </span>
          </div>
          <div className="acc-card__body">
            {state === "empty" ? (
              <Notice kind="empty" title="سلة فارغة">
                ...
                <p className="acc-choice__note">
                  <strong>المسار</strong> · «ابحث في السوق» أو «موردون تتابعهم». ولا اقتراح إعادة
                  توريد: ذاك مؤجَّل إلى مرحلة النموّ.
                </p>
            ...
            {state === "stale" ? (
              <Notice kind="warning" title="السعر تغيّر بعد المسودة">
                ...
                <p className="acc-choice__note">
                  <strong>لا تأكيد محلي</strong> · المسودة لا تُثبّت سعراً. السعر يُثبت بقبول المورد
                  لا بحفظ المشتري.
                </p>
                <p className="acc-choice__note">
            ...
            {state === "validation_error" ? (
              <Notice kind="warning" title="وحدة أو حدٌّ أدنى غير مستوفى">
                ...
                <p className="acc-choice__note">
                  ...
                  تُقارَن بالسعر. نعرض السعر للوحدة الأساسية ونسمّي الفرق.
                </p>
                <p className="acc-choice__note">
            ...
            {lines && lines.length ? (
              <>
                ...
                <p className="acc-choice__note">
                  <strong>طلبان لا طلب</strong> · الإرسال يُنشئ طلباً لكل مورد. طلبٌ واحد لموردين
                  يعني مسؤوليةً مشتركة لا تقبلها منشأتان مستقلتان.
                </p>
                <p className="acc-choice__note">
