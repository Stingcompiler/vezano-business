          ...
          <div className="acc-card__body">
            ...
            {state === "validation_error" && p?.ledger.open_shift ? (
              ...
              >
                ...
                <p className="acc-choice__note">
                  <strong>نقل ملكية المنشأة — ORG-09</strong> · أخطر إجراء في النظام: ينقل الدفتر
                  كله ومعه الذمم والأجهزة والاشتراك. لا نقل أثناء وردية مفتوحة أو معلّق غير مرفوع.
                </p>
              </Notice>
            ) : null}
            ...
            {state === "success" && done ? (
              <Notice kind="success" title="سُحب الوصول">
                ...
                <p className="acc-choice__note">
                  ...
                  لا شاشةَ خطأٍ غامضة يظنّها عطباً فيتصل بالدعم (ACC-45).
                </p>
                <p className="acc-choice__note">
              ...
              <>
                ...
                {choice === "wipe" ? (
                  <TextField
                    ...
                    hint="يُسجَّل باسمك في سجل التدقيق — المعلّق على الجهاز يُعدّ مفقوداً إلا ما يُسترد من SYS-07 قبل المحو"
                    value={ack}
