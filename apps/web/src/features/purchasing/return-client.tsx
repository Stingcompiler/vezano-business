          ...
          <div className="acc-card__body">
            ...
            {state === "validation_error" ? (
              <Notice kind="error" title="ردٌّ أكثر مما استُلم">
                ...
                <p className="acc-lead">
                  <strong>السبب</strong> · إلزامي لأنه يُقرأ في «تحليلات المورد»: «تالف» حكمٌ على
                  المورد، و«خطأ في الطلب» حكمٌ علينا.
                </p>
                <p className="acc-choice__note">
            ...
            {doc && doc.status === "approved" && !viewing ? (
              <>
                ...
                <p className="acc-choice__note">
                  السبب إلزامي لكل سطر: المرتجع بلا سبب لا يُقرأ في تحليلات المورد ولا يُحاجَج به.
                  «تالف» و«خطأ في الطلب» و«قارب الانتهاء» ثلاثة أحكام مختلفة على المورد.
                </p>
                <div className="acc-choice__head">
                  <strong>قيمة المرتجع</strong>
