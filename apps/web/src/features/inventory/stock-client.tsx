        ...
        <div>
          ...
          <div className="acc-choice__note">
            {r.tag === "negative" ? (
              ...
              "بلا سعر وبلا معامل تحويل. يُباع بسعر يدوي في نقطة البيع ولا يدخل تقارير القيمة حتى يُستكمل."
            ) : (
              "سليم"
            )}
          </div>
        ...
        <div className="cat-table pos-card">
          <div className="cat-head">
            ...
            <span className="cat-head__hint">
              الرصيد السالب يُنبَّه عليه ولا يمنع البيع. لكل رصيد تغطية زمنية.
            </span>
          </div>
          <div className="acc-card__body">
            ...
            {state === "empty" ? (
              ...
              >
                ...
                <p className="acc-choice__note">
                  <strong>المسار</strong> · «أدخل افتتاحيات المخزون» أو «استلم بضاعة». والفراغ هنا
                  بدايةٌ لا عطب.
                </p>
              </Notice>
            ) : null}
