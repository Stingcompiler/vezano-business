...
(`market_publish` في ORG-02)؛ الصلاحية تبدأ الآن وتنتهي بتاريخها ما لم تُجدَّد صريحاً (MP-13).
"""
...
STATUS_MEANING = {
    ...
    "expired": "انتهت الصلاحية {until}. لا يظهر للمشتري كسعر، ويحتاج تجديد تأكيد (MP-13) — "
