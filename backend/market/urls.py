...
from market.views import (
    ...
    MarketInvitesView,
    MarketLinkDocumentActionView,
    MarketLinkDocumentsView,
    ...
    MarketLinkReceiptActionView,
    MarketLinkReceiptsView,
    MarketLinkReturnActionView,
    MarketLinkReturnsView,
...
urlpatterns = [
    ...
    # LINK-03/04/05 (M3 — T3.26)
    path("market/link/receipts", MarketLinkReceiptsView.as_view(), name="market-link-receipts"),
    path(
        "market/link/receipts/<uuid:shipment_id>/<str:action>",
        MarketLinkReceiptActionView.as_view(),
        name="market-link-receipt-action",
    ),
    path("market/link/documents", MarketLinkDocumentsView.as_view(), name="market-link-documents"),
    path(
        "market/link/documents/<uuid:link_id>/<str:action>",
        MarketLinkDocumentActionView.as_view(),
        name="market-link-document-action",
    ),
    path("market/link/returns", MarketLinkReturnsView.as_view(), name="market-link-returns"),
    path(
        "market/link/returns/<uuid:return_id>/<str:action>",
