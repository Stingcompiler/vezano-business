...
from stingops.views import (
    ...
    OperatorDemoRequestActionView,
    OperatorDemoRequestsView,
    OperatorDisputeActionView,
    OperatorDisputesView,
    OperatorEntitlementsView,
    OperatorFlagsView,
    OperatorHealthView,
    OperatorLoginView,
    OperatorM0View,
    OperatorOperatorActionView,
...
urlpatterns = [
    ...
    path(
        "platform/tenants/<uuid:tenant_id>/subscription",
        OperatorSubscriptionView.as_view(),
