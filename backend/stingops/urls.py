...
from stingops.views import (
    ...
    OperatorAppealActionView,
    OperatorAudiencePreviewView,
    OperatorBackupActionView,
    OperatorBackupsView,
    OperatorChannelStateView,
    OperatorDisputeActionView,
    OperatorDisputesView,
    OperatorHealthView,
    OperatorLoginView,
...
urlpatterns = [
    ...
    path("platform/reports", OperatorReportsView.as_view(), name="platform-reports"),
    path(
        "platform/reports/<uuid:tenant_id>/<uuid:report_id>/decide",
        OperatorReportActionView.as_view(),
        name="platform-report-decide",
    ),
    path(
        "platform/appeals/<uuid:tenant_id>/<uuid:offer_id>/decide",
        OperatorAppealActionView.as_view(),
        name="platform-appeal-decide",
    ),
    path("platform/disputes", OperatorDisputesView.as_view(), name="platform-disputes"),
    path(
        "platform/disputes/<uuid:tenant_id>/<uuid:dispute_id>/<str:action>",
        OperatorDisputeActionView.as_view(),
        name="platform-dispute-action",
    ),
    path("platform/health", OperatorHealthView.as_view(), name="platform-health"),
    path("platform/backups", OperatorBackupsView.as_view(), name="platform-backups"),
    path(
        "platform/backups/<uuid:backup_id>/<str:action>",
        OperatorBackupActionView.as_view(),
        name="platform-backup-action",
    ),
]
